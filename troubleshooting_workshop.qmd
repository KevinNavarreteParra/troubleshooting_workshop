...
::: {.fragment .fade-in-then-semi-out}
Of course, there are a few things that are used more frequently than others. Just like in English we use "the" more than "antidisestablishmentarianism", in R we use `mean()` far more often than `strtrim()`.
:::
